...
const Topbar: React.FC = () => {
  ...
  return (
    <div className="w-full min-h-topbar max-h-topbar pr-xlarge bg-brand pl-base bg-grey-0 border-b border-grey-20 sticky top-0 flex items-center justify-between z-40">
      <SearchBar />
