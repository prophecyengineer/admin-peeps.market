  ...
  (
    ...
    return (
      <div className={clsx("w-full", className)} {...props}>
        ...
        <div
          className={clsx(
            "w-full flex items-center  px-small py-xsmall rounded-rounded h-10 focus-within:shadow-input focus-within:border-violet-60 ",
            {
        ...
        >
          ...
          <input
            className=" outline-none outline-0 w-full remove-number-spinner leading-base text-grey-90 font-normal caret-violet-60 placeholder-grey-40"
            ref={inputRef}
            autoComplete="off"
            name={name}
